...
public class OBD_filter extends Activity {
    ...
    private static boolean onBoardCharger;
    //private static String quickCharge;
    private static boolean quickCharge;
    ...
    public static boolean getQuickCharge(){
        return quickCharge;
    }

    public static boolean getOnBoardCharger(){
